...
export const recommendations = [
  {
    ...
    description:
      "Your discretionary spending is stable. Moving 4,000 ETB more into savings each month can improve your financial health score.",
    confidenceScore: 92,
    priority: "HIGH",
    status: "NEW",
  },
  {
    ...
    description:
      "Your risk appetite and surplus cash flow fit a moderate-growth investment option.",
    confidenceScore: 84,
    priority: "MEDIUM",
    status: "VIEWED",
  },
  {
    ...
    description:
      "Inventory payments are creating a cash-flow dip. A 15-day extension can reduce short-term liquidity pressure.",
    confidenceScore: 88,
    priority: "HIGH",
    status: "NEW",
  },
...
export const notifications = [
  ...
  },
  {
    ...
    message:
      "Projected outflow exceeds inflow next week. Review supplier payments.",
    type: "RISK",
    read: false,
...
export const businessReports = [
  {
    ...
    healthScore: 78,
    summary:
      "Revenue is growing, but supplier payments are creating short-term liquidity pressure.",
  },
];
